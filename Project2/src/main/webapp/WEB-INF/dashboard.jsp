...
<body>
	...
	%>
		...
		<h3 style="text-align: center;">
			Register : <input type="button" onclick="window.location.href='register.jsp';" value="Register">
		</h3>
		<br>
		<br>
	...
	%>
		...
		<br>
		<h3 style="text-align: center;">
			Create Task : <input type="button" onclick="window.location.href='newtask.jsp';" value="Create Task"><br>
			<br> Check Status : <input type="button" onclick="window.location.href='getstatus';" value="Status">
		</h3>
		<h1 style="text-align: end;">
			<input type="button" onclick="window.location.href='logout.jsp';" value="logout">
		</h1>
	...
	%>
		...
		<br>
		<h3 style="text-align: center;">
			Check Task : <input type="button" onclick="window.location.href='task.jsp';" value="Task"><br>
			<br>
		</h3>
		<%
		}
